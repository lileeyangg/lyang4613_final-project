...
After completing an extensive exploration, the previous asked questions can be answered from the data.
...
p <-ggplot(total_gross_by_genre, aes(x = genre, y = total_gross_by_genre)) +
...
```
++From this analysis it can be concluded that adventure movies clearly generate the largest amount of gross profit overall. These adventure movies include films like "Starwars: The Force Awakens", "The Lion King", "Toy Story" and many more. The reason this could be is that kids love these type of hero going on an adventure through life as cartoons or films. This could be a reason why they have generated the largest profit and has been some of the well known films.
